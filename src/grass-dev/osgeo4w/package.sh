...
OSGEO4W_ROOT_MSYS="/d/a/OSGeo4W/OSGeo4W/src/grass-dev/osgeo4w"
OSGEO4W_ROOT=$(cygpath -mw "$OSGEO4W_ROOT_MSYS")
...
echo " Step 8"
	...
	[ -f msys64/msys2.init ] || {
		cmd.exe /c echo "bash pacman-key --init"
...
sdesc: "GRASS GIS 8.0.0"
ldesc: "Geographic Resources Analysis Support System (GRASS GIS) 8.0"
category: Desktop
